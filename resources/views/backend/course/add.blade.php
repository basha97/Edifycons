                ...
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" ng-model="form.course.course_name" type="text" placeholder="course name">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="name">Course Category</label>
                                        <select class="form-control" id="exampleFormControlSelect1" ng-model="form.course.course_menu">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" ng-model="form.course.course_img_url" class="form-control" id="courseImage">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" ng-model="form.course.course_short_description"   rows="9" placeholder="Short Description.."></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="ccnumber">Long Description</label>
                                        <textarea class="form-control" ng-model="form.course.course_long_description"   rows="9" placeholder="Long Description.."></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="card" ng-repeat="list in form.course.course_content track by $index">
                                        <div class="card-header">
                                            ...
                                            <div class="row">
                                                <strong style="padding-left: 10px;">Course Content <span>@{{$index+1}}</span></strong>
                                                <div style="margin-left:auto">
                                                    <a href="javascript:;" ng-click="add_content_section($index)" ng-show=" $index== form.course.course_content.length-1"  class="btn btn-sm btn-primary" type="submit"><i class="fa fa-dot-circle-o"></i> Add</a>
                                                    <a href="javascript:;" ng-click="remove_content_section($index)"  class="btn btn-sm btn-danger" type="reset"><i class="fa fa-ban"></i> Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"  ng-model="list.course_content_title" type="text" placeholder="course name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="name">Description</label>
                                                         <textarea class="form-control" ng-model="list.course_content_description" id="exampleFormControlTextarea1" rows="3"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer">
                            <a href="javascript:;"  ng-click="addCourseFunc(form)" class="btn  btn-primary" type="submit">
...
<script type="text/javascript">
    ...
    app.controller('edifyconsCourseCntrl', function($scope,$http,$timeout) {
        ...
        $scope.addCourseFunc    =   function(data){
            $http.post('{!! route('addcoursepost') !!}',data).then(function success(e){
                console.log(e);
