...
/* --------------------------------------------
:: Template Name: Wick J - Coaching, Business Training & Consulting HTML5 Template
:: Template Author: Hirotheme
:: Template Author URI: https://themeforest.net/user/hirotheme/portfolio
:: Description: Wick is a Multipage based Business Template. It's very clean, creative & beautiful. It's super responsive & ultra light.
:: Tags: Wick, Business Template,  Bootstrap 4, HTML Template, HTML5 Template.
:: Version: v1.0.0
-------------------------------------------- */
